# auto_csv_download.rb 20180530.2112
...
loop do
  ...
  begin
    csvdownloadlink = driver.find_element(:xpath, '/html/body/baw-app/ng-component/mat-sidenav-container/mat-sidenav-content/div/ng-component/div/div/ng-component/div/div[7]/baw-csv-download-button/a')
